    ...
    <div className="p-6 space-y-6">
      <div className="max-w-7xl mx-auto">
        <DashboardHeader
          ...
          description="Comprehensive financial analysis metrics and fraud detection insights"
          metrics={[
            {
              title: 'Total Analyses',
              value: mockAnalyticsData.totalAnalyses,
              change: `+${mockAnalyticsData.monthlyGrowth}% growth`,
              icon: <svg className="w-6 h-6 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" /></svg>,
              delay: 0,
            },
            {
              title: 'Fraud Detected',
              value: mockAnalyticsData.fraudDetected,
            ...
            {
              title: 'Accuracy Rate',
              value: `${mockAnalyticsData.processingAccuracy}%`,
            ...
            },
            {
              ...
              value: `${mockAnalyticsData.avgTurnaroundTime}m`,
              change: 'Per document',
            ...
            },
            {
              ...
              change: 'This month',
              icon: <svg className="w-6 h-6 text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1" /></svg>,
              delay: 0.4,
            },
          ]}
        />
